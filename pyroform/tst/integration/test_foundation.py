"""
Integration Tests: Foundation & Core Infrastructure
"""
...
class TestFoundation:
    ...
    def test_cli_argument_parsing(self):
        ...
        assert "Pyroform" in result.output
    ...
    def test_multiple_config_merging(self, temp_pyro_files):
        ...
        config1 = {
            "Label": "Config 1",
            "Users": [
                {"label": "u1", "Name": "user1", "Password": "pass1", "Groups": []}
            ],
            "Groups": [],
            "Devices": [],
        }
        ...
        config2 = {
            "Label": "Config 2",
            "Users": [
                {"label": "u2", "Name": "user2", "Password": "pass2", "Groups": []}
            ],
