...
from pyroform.src.models import PyroConfig, User, Group, Device, Exclude
...
def test_json_file(tmp_path):
    ...
    data = {
        "Label": "JSON Config",
        "Users": [{"label": "user1", "Name": "user1", "Password": "pass", "Groups": []}],
        "Groups": [],
        "Devices": []
    }
...
class TestPyroParserInitialization:
    ...
    def test_init_default_stdout(self):
        ...
        with patch('pyroform.src.parser.STDOUTMsg') as mock_stdout_cls:
            ...
            mock_stdout_cls.assert_called_once_with(
                debug_mode=False,
                timestamp=False
            )
    ...
    def test_init_with_args_kwargs(self):
        ...
        # Should accept but ignore extra arguments
        parser = PyroParser("arg1", "arg2", stdout=None, extra_kwarg="value")
...
class TestParseMethod:
    ...
    def test_parse_invalid_path_type(self, mock_stdout, tmp_path):
        ...
        with patch.object(Path, 'is_file', return_value=False), \
            ...
            with pytest.raises(ValueError, match="Input path is neither file nor directory"):
    ...
    def test_parse_current_directory(self, mock_stdout):
        ...
        with patch.object(Path, 'is_dir', return_value=True), \
             patch.object(parser, '_parse_directory') as mock_parse_dir:
...
class TestParseSingleFile:
    ...
    def test_parse_json_file(self, mock_stdout, tmp_path):
        ...
        with patch.object(parser, '_parse_single_file_data') as mock_parse_data:
            ...
            mock_stdout.info.assert_called_with(f'Parsing Pyro state file ({json_file})...')
...
#       """Test that error messages are properly formatted."""
    ...
    def test_parse_single_file_logging(self, mock_stdout, tmp_path):
        ...
        with patch.object(parser, '_parse_single_file_data') as mock_parse_data:
            ...
            mock_stdout.info.assert_any_call(f'Parsing Pyro state file ({json_file})...')
