    ...
    def _create_flow_config(self):
        ...
        class FlowConfig:
            def __init__(self, config_dict):
                self.state_file = config_dict.get("state_file", "/tmp/pyroform_state.json")
                self.logging = type('Logging', (), config_dict.get("logging", {}))()
                self.execution = type('Execution', (), config_dict.get("execution", {}))()
                self.reporting = type('Reporting', (), config_dict.get("reporting", {}))()
